...
const Home = () => {
  ...
  return (
    ...
    <button
      ...
      className="text-base md:text-xl font-medium bg-red-900 rounded-[3rem] h-16 w-60 md:h-20 md:w-100 m-4 md:m-8 hover:scale-103 hover:bg-red-800"
    >
    ...
    <p className="text-white text-2xl md:text-5xl font-medium">As an engineer who codes<br/>
